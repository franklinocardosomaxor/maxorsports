...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.png?v=maxor3", type: "image/png", sizes: "64x64" },
      { rel: "shortcut icon", href: "/favicon.png?v=maxor3", type: "image/png" },
      { rel: "apple-touch-icon", href: "/apple-touch-icon.png?v=maxor3" },
