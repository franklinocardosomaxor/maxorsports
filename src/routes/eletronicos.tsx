...
const HEADER_GRADIENT = "linear-gradient(120deg, #0F1720 0%, #103642 55%, #00BFC6 100%)";

export const Route = createFileRoute("/eletronicos")({
  component: EletronicosPage,
  head: () => ({
    meta: [
      { title: "Eletrônico — Maxor Sports" },
      { name: "description", content: "Eletrônicos esportivos Maxor Sports: tecnologia para acompanhar sua performance." },
      { property: "og:title", content: "Eletrônico — Maxor Sports" },
      { property: "og:description", content: "Tecnologia e eletrônicos esportivos com a curadoria Maxor Sports." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://maxorsports.lovable.app/eletronicos" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "https://maxorsports.lovable.app/eletronicos" }],
  }),
});

function EletronicosPage() {
  useCatalogVersion();
  const products = getCategoryProducts("Eletrônico") as unknown as CatalogProduct[];
      ...
      <Shell active="Diversos">
        <div className="border-b border-white/10 bg-navy">
          <div className="mx-auto flex max-w-7xl items-center gap-2 px-4 py-3 text-xs font-semibold uppercase tracking-wider text-[color:var(--lime-brand)]">
            ...
            <span className="text-offwhite">Eletrônico</span>
          </div>
        </div>
        ...
        >
          <div className="relative mx-auto max-w-7xl px-4 py-12 sm:py-16">
            ...
            <p className="mt-3 max-w-2xl text-sm text-offwhite/80 sm:text-base">
              Em breve: tecnologia e eletrônicos para quem leva o esporte a sério.
            </p>
          </div>
        </section>

        <div className="mx-auto max-w-7xl px-4 py-16 text-center">
          <p className="text-sm text-offwhite/60">Nenhum eletrônico cadastrado no catálogo ainda.</p>
          <Link
            to="/"
  ...
  return (
    <CatalogPage
      activeNav="Diversos"
      breadcrumb={["Eletrônico"]}
      theme={{
        eyebrow: "Curadoria Maxor",
        title: "Eletrônico",
        subtitle: "Tecnologia para quem leva o esporte a sério — relógios, fones e muito mais.",
